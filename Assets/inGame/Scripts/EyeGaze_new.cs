...
public class EyeGaze_new : MonoBehaviour
{
    public static EyeGaze_new Instance;
    ...
    public (Vector3,Vector3) getGazeCoordinates()
    {
        return (CombineGazeOrigin, CombineGazeDirection);
    }
